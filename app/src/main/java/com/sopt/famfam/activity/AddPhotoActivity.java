...
public class AddPhotoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) *//*{
        ...
        iv_image = (ImageView) findViewById(R.id.);
            ...
            public void onClick(View view) {
                ...
                PermissionListener permissionlistener = new PermissionListener() {
                    ...
                    public void onPermissionGranted() {
                        ...
                        TedBottomPicker bottomSheetDialogFragment = new TedBottomPicker.Builder(AddPhotoActivity.this)
                    ...
                    public void onPermissionDenied(ArrayList<String> deniedPermissions) {
                        Toast.makeText(AddPhotoActivity.this, "Permission Denied\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
                    }


                };

                TedPermission.with(AddPhotoActivity.this)
