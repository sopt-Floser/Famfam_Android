...
class FindPwActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tv_find_pw_act_request_code_btn.setOnClickListener(this)
        tv_find_pw_act_complete_btn.setOnClickListener(this)
        btn_find_pw_resend_code.setOnClickListener(this)
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationFailed(e: FirebaseException) {
                ...
                if (e is FirebaseAuthInvalidCredentialsException) {
                    // Invalid request
                    // [START_EXCLUDE]
                    et_find_pw_act_input_phone_number.error = "Invalid phone number."
                    // [END_EXCLUDE]
...
//        setOnBtnClickListener()
    ...
    public override fun onStart() {
        ...
        if (verificationInProgress && validatePhoneNumber()) {
            val number: String = et_find_pw_act_input_phone_number.text.toString()
            ...
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    if (task.exception is FirebaseAuthInvalidCredentialsException) {
                        ...
                        // [START_EXCLUDE silent]
                        et_find_pw_act_input_code.error = "Invalid code."
                        // [END_EXCLUDE]
                    }
                    // [START_EXCLUDE silent]
                    // Update UI
    ...
    private fun updateUI(uiState: Int, user: FirebaseUser? = auth.currentUser, cred: PhoneAuthCredential? = null) {
        ...
        when (uiState) {
            STATE_INITIALIZED -> {
                ...
                enableViews(tv_find_pw_act_request_code_btn_text, et_find_pw_act_input_phone_number)
                disableViews(tv_find_pw_act_request_code_btn, btn_find_pw_resend_code, et_find_pw_act_input_code)
//                detail.text = null
            }
            STATE_CODE_SENT -> {
                // Code sent state, show the verification field, the
                enableViews(
                    tv_find_pw_act_request_code_btn_text,
                    btn_find_pw_resend_code,
                    et_find_pw_act_input_phone_number,
                    et_find_pw_act_input_code
                )
                disableViews(tv_find_pw_act_request_code_btn)
//                detail.setText(R.string.status_code_sent)
            ...
            STATE_VERIFY_FAILED -> {
                ...
                enableViews(
                    tv_find_pw_act_request_code_btn_text,
                    tv_find_pw_act_request_code_btn,
                    btn_find_pw_resend_code,
                    et_find_pw_act_input_phone_number,
                    et_find_pw_act_input_code
                )
...
//                detail.setText(R.string.status_verification_succeeded)
                ...
                if (cred != null) {
                    if (cred.smsCode != null) {
                        et_find_pw_act_input_code.setText(cred.smsCode)
                    } else {
                        et_find_pw_act_input_code.setText(R.string.instant_validation)
                    }
                }
            }
            STATE_SIGNIN_FAILED ->
...
//        }
    ...
    private fun validatePhoneNumber(): Boolean {
        ...
        val phoneNumber = et_find_pw_act_input_phone_number.text.toString()
    ...
    override fun onClick(view: View) {
        ...
        when (view.id) {
            R.id.tv_find_pw_act_request_code_btn -> {

                Log.v("uuuu1", "tv_certification_act_request_code_btn_text")
                if (!validatePhoneNumber()) {
                    return
                }
                et_find_pw_act_input_code.requestFocus()
                find_pw_act_request_code_layout.visibility = View.VISIBLE
                tv_find_pw_act_complete_btn.visibility = View.VISIBLE
                tv_find_pw_act_request_code_btn.visibility = View.GONE

                startPhoneNumberVerification(phoneNumber)
                Log.d("uuuu1", phoneNumber)
            }
            R.id.tv_find_pw_act_complete_btn -> {
                et_find_pw_act_phone_number_layout.visibility = View.INVISIBLE
                find_pw_act_request_code_layout.visibility = View.GONE
                //tv_find_id_act_user_id 찾은 아이디 통신에서 받아서 붙이기
                val code = et_find_pw_act_input_code.text.toString()
                if (TextUtils.isEmpty(code)) {
                    et_find_pw_act_input_code.error = "Cannot be empty."
                    return
                }
                verifyPhoneNumberWithCode(storedVerificationId, code)
                startActivity<ResettingPwActivity>()
                finish()
            }
