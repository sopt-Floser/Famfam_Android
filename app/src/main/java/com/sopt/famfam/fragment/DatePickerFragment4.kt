...
//        ).show()
        ...
        activity.findViewById<TextView>(R.id.et_find_id_act_input_birthday_text).hint = "$year-$realMonth-$realDay"
        activity.findViewById<TextView>(R.id.et_find_id_act_input_birthday_text).text = birth
    }
